...
<div class="sub_page">
<div class="cnt_wrap flex_wrap justify_start">
<?php $categories = get_categories($args);
foreach($categories as $category): 
	$cat_id = $category->cat_ID;
$post_id = 'category_'.$cat_id; 
$catimg = get_field('catimage',$post_id);
$img = wp_get_attachment_image_src($catimg, 'full');?>
<div class="staff">
<div class="staffphoto"><a href="../category/<?php echo $category->category_nicename; ?>"><img src="<?php echo $img[0]; ?>" alt="<?php echo $category->cat_name; ?>" /></a></div>
<div class="staffname"><p><?php echo esc_html($category->name); /* カテゴリ名 */ ?></p></div>
</div>
<?php endforeach; ?>
</div>
</div>
...
add_shortcode('categories', 'blogcategory');
